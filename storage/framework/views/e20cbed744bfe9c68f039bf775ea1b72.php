...
<?php $__env->startSection('title', 'Hoạt động của tôi'); ?>
<?php $__env->startSection('page-title', 'Hoạt động của tôi'); ?>

<?php $__env->startSection('page-actions'); ?>
    <?php if(auth()->user()->hasPermission('activity_logs.view_all')): ?>
        <a href="<?php echo e(route('activity-logs.index')); ?>" class="btn btn-primary">
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('activity-logs.my-activities')); ?>">
                    <div class="row g-3">
                        <div class="col-md-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            ...
                            <a href="<?php echo e(route('activity-logs.my-activities')); ?>" class="btn btn-secondary">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h3 class="mb-0"><?php echo e($activityLogs->total()); ?></h3>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h3 class="mb-0">
                            <?php echo e($activityLogs->where('created_at', '>=', now()->startOfDay())->count()); ?>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\appevent\appevent\resources\views/activity-logs/my-activities.blade.php ENDPATH**/ ?>