            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('timelines.*') ? 'active' : ''); ?>" href="<?php echo e(route('timelines.index')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('event-reports.*') ? 'active' : ''); ?>" href="<?php echo e(route('event-reports.index')); ?>">
