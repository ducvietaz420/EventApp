            ...
            <div class="card-body text-center">
                ...
                <div class="row text-center">
                    <div class="col-12 mb-2">
                        <h5 class="text-primary mb-0"><?php echo e(number_format($totalBudget, 0, ',', '.')); ?> VNĐ</h5>
                        <small class="text-muted">Tổng ngân sách</small>
                    </div>
                    <div class="col-6">
                        <h6 class="text-danger mb-0"><?php echo e(number_format($totalSpent, 0, ',', '.')); ?></h6>
                        <small class="text-muted">Đã chi</small>
                    </div>
                    <div class="col-6">
                        <h6 class="text-success mb-0"><?php echo e(number_format($remaining, 0, ',', '.')); ?></h6>
        ...
        <div class="tab-content" id="eventTabsContent">
            ...
            <div class="tab-pane fade show active" id="timeline" role="tabpanel">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?php echo e(route('events.timelines.create', $event->id)); ?>" class="btn btn-sm btn-primary">
                        <i class="fas fa-plus me-1"></i>Thêm mốc thời gian
                    </a>
                </div>
                
                <?php if($event->timelines->count() > 0): ?>
                    <div class="timeline">
                        <?php $__currentLoopData = $event->timelines->sortBy('start_time'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="text-center">
                                            ...
                                            <div class="mt-2">
                                                <strong><?php echo e($timeline->start_time ? $timeline->start_time->format('H:i') : 'N/A'); ?></strong><br>
                                                <small class="text-muted"><?php echo e($timeline->start_time ? $timeline->start_time->format('d/m/Y') : 'N/A'); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="card border-left-primary">
                                            <div class="card-body py-2">
                                                ...
                                                <p class="text-muted mb-1"><?php echo e($timeline->description); ?></p>
                                                <?php if($timeline->end_time): ?>
                                                    <small class="text-muted">
                                                        <i class="fas fa-arrow-right me-1"></i>
                                                        Kết thúc: <?php echo e($timeline->end_time->format('H:i d/m/Y')); ?>
                ...
                <?php else: ?>
                    <div class="text-center py-4">
                        ...
                        <a href="<?php echo e(route('events.timelines.create', $event->id)); ?>" class="btn btn-primary">
            ...
            <div class="tab-pane fade" id="budget" role="tabpanel">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?php echo e(route('events.budgets.create', $event->id)); ?>" class="btn btn-sm btn-primary">
                        <i class="fas fa-plus me-1"></i>Thêm khoản ngân sách
                    </a>
                </div>
                
                <?php if($event->budgets->count() > 0): ?>
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $event->budgets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $budget): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($budget->item_name); ?></td> 
                                        <td class="text-end"><?php echo e(number_format($budget->estimated_cost, 0, ',', '.')); ?> VNĐ</td>
                                        <td class="text-end">
                                            <span class="<?php echo e($percentage > 100 ? 'text-danger' : 'text-primary'); ?>">
                                                <?php echo e(number_format($budget->actual_cost, 0, ',', '.')); ?> VNĐ
                                            </span>
                                        </td>
                                        <td class="text-end">
                                            <span class="<?php echo e($remaining < 0 ? 'text-danger' : 'text-success'); ?>">
                                                <?php echo e(number_format($remaining, 0, ',', '.')); ?> VNĐ
                                            </span>
                                        </td>
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm">
                                                <a href="<?php echo e(route('budgets.edit', $budget->id)); ?>" class="btn btn-outline-warning">
                ...
                <?php else: ?>
                    <div class="text-center py-4">
                        ...
                        <a href="<?php echo e(route('events.budgets.create', $event->id)); ?>" class="btn btn-primary">
            ...
            <div class="tab-pane fade" id="suppliers" role="tabpanel">
                ...
                <?php if($event->suppliers->count() > 0): ?>
                    <div class="row">
                        <?php $__currentLoopData = $event->suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-6 mb-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                <h6 class="mb-1"><?php echo e($supplier->name); ?></h6>
                                                <p class="text-muted mb-1"><?php echo e($supplier->service_type); ?></p>
                                                <?php if($supplier->pivot->role): ?>
                                                    <span class="badge bg-info"><?php echo e($supplier->pivot->role); ?></span>
                                                <?php endif; ?>
                                            </div>
                                            <div class="text-end">
                                                <?php if($supplier->pivot->contract_value): ?>
                                                    <strong><?php echo e(number_format($supplier->pivot->contract_value, 0, ',', '.')); ?> VNĐ</strong>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <?php if($supplier->contact_person || $supplier->phone): ?>
                                            <hr class="my-2">
                                            <div class="small text-muted">
                                                <?php if($supplier->contact_person): ?>
                                                    <div><i class="fas fa-user me-1"></i><?php echo e($supplier->contact_person); ?></div>
                                                <?php endif; ?>
                                                <?php if($supplier->phone): ?>
                                                    <div><i class="fas fa-phone me-1"></i><?php echo e($supplier->phone); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
