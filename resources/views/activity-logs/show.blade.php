                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center mt-1">
                                ...
                                <div>
                                    <div>{{ $activityLog->user->name ?? 'Người dùng đã xóa' }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-1">
                                <span class="badge bg-{{ $activityLog->action_class }} fs-6">
                                    <i class="{{ $activityLog->action_icon }} me-1"></i>
                                    {{ $activityLog->action_display }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-1">
                                {{ $activityLog->created_at->format('d/m/Y H:i:s') }}<br>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-1">{{ $activityLog->description }}</div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-1">
                                <code>{{ $activityLog->ip_address ?? 'Không xác định' }}</code>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-1">
                                <small class="text-muted">{{ $activityLog->user_agent ?? 'Không xác định' }}</small>
                            </div>
                        </div>
                        ...
                        @if($activityLog->model_type && $activityLog->model_id)
                            <div class="mb-3">
                                ...
                                <div class="mt-1">
                                    <span class="badge bg-info">{{ class_basename($activityLog->model_type) }}</span>
                                    <code>#{{ $activityLog->model_id }}</code>
                                </div>
                            </div>
                        @endif
                    </div>
            ...
            <div class="card-body">
                <div class="timeline">
                    <div class="timeline-item">
                        <div class="timeline-marker bg-{{ $activityLog->action_class }}">
                            <i class="{{ $activityLog->action_icon }}"></i>
                        </div>
                        <div class="timeline-content">
                            <h6 class="mb-1">{{ $activityLog->action_display }}</h6>
                            <p class="mb-1">{{ $activityLog->description }}</p>
                            <small class="text-muted">
                                <i class="fas fa-clock me-1"></i>{{ $activityLog->created_at->format('d/m/Y H:i:s') }}
                                <i class="fas fa-map-marker-alt ms-3 me-1"></i>{{ $activityLog->ip_address }}
                            </small>
                        </div>
                    </div>
                </div>
